...
{
    return GetBoolArg("-testnet", false) ? 15557 : 13357;
}
...
string HTTPPost(const string& strMsg, const map<string, string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: RNRC-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
#define GET_STREAM_IO_SERVICE(s) ((boost::asio::io_context&)(s).get_executor().context())
#else
#define GET_STREAM_IO_SERVICE(s) ((s).get_io_service())
#endif
...
public:
    ...
    {
        ip::tcp::resolver resolver(GET_STREAM_IO_SERVICE(stream));
...
#if BOOST_VERSION >= 107000
#define GET_ACCEPTOR_IO_SERVICE(s) ((boost::asio::io_context&)(s)->get_executor().context())
#else
#define GET_ACCEPTOR_IO_SERVICE(s) ((s)->get_io_service())
#endif
...
{
    // Accept connection
    AcceptedConnectionImpl<Protocol>* conn = new AcceptedConnectionImpl<Protocol>(GET_ACCEPTOR_IO_SERVICE(acceptor), context, fUseSSL);
...
void ThreadRPCServer2(void* parg)
{
    ...
    if ((mapArgs["-rpcpassword"] == "") ||
        ...
        string strWhatAmI = "To use RNRCd";
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("%s, you must set a rpcpassword in the configuration file:\n %s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"RNRC Alert\" admin@foo.com\n"),
                                             strWhatAmI.c_str(),
