...
{
    switch (unit) {
    case BTC: return QString("RNRC");
    case mBTC: return QString("mRNRC");
    case uBTC: return QString::fromUtf8("μRNRC");
...
{
    switch (unit) {
    case BTC: return QString("RNRCs");
    case mBTC: return QString("Milli-RNRCs (1 / 1,000)");
    case uBTC: return QString("Micro-RNRCs (1 / 1,000,000)");
    default: return QString("???");
    }
}
