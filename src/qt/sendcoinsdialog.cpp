                                                    ...
                                                    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a RNRC address (e.g. B8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)"));
#endif
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model) {
        ...
        if (text.isEmpty())
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid RNRC address"));
        } else {
