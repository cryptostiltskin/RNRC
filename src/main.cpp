...
const string strMessageMagic = "RNRC Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if (nBestHeight > 0 && nBestHeight < 11) {
...
{
    int64_t nSubsidy = nCoinAge * 33 / (365 * 33 + 8) * (200 * CENT); // 200% Forever
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes) {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RNRC", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty()) {
        ...
        const char* pszTimestamp = "Rock N Rain is born on 20-02-2019.";
        CTransaction txNew;
        txNew.nTime = 1550695709;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1550695709;
        block.nBits = bnProofOfWorkLimit.GetCompact();
        block.nNonce = !fTestNet ? 1155889 : 1155889;
        ...
        assert(block.hashMerkleRoot == uint256("0x9b4baec281fa15825f4fa358d0817695d64ab1fa180c845782b219bc7d53fb3f"));
...
unsigned char pchMessageStart[4] = {0x9a, 0xd1, 0x18, 0xe9};
